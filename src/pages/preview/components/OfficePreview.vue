...
<template>
  <div v-if="!isCanPreview" class="no-preview-container">
    ...
    <span class="no-preview-text">{{ currentLanguage.pages.preview.nonsupportPreviewOffice }}</span>
  </div>
  ...
  <div v-if="isLoadingFailed" class="no-preview-container">
    <font-awesome-icon :icon="['fas', 'read-failed-file']" class="no-preview-icon" />
