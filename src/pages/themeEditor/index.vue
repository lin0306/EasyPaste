 ...
 * 显示文件所在位置
 */
const onShowFile = async (): Promise<void> => {
...
<template>
  ...
  <div class="editor-content">
    ...
    <!-- 主题导出完成确认框 -->
    <n-modal
      v-model:show="exportSuccessModalVisible"
      title="主题导出完成"
      preset="dialog"
      :closable="false"
    >
