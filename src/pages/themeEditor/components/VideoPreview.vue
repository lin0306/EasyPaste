...
<template>
  <n-collapse-item
    class="custom-theme-collapse-item"
    title="音频组件"
    name="4"
    @click="initWavesurfer"
  >
    <div class="waveform-wrapper">
      ...
      <div v-show="!isLoadingWaveform">
        ...
        <n-slider
          ...
          :format-tooltip="
            (val: number) => {
              return convertSecondsToTime(val)
            }
          "
        />
