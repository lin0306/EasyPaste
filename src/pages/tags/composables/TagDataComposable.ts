 ...
 * 显示添加面板
 */
export const showAddPanel = (): void => {
  // 隐藏的时候回滚数据
 ...
 * 刷新列表页面的标签
 */
export const reloadListTags = async (): Promise<void> => {
