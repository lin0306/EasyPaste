...
const initUpdateAnimationEffectListener = async (): Promise<UnlistenFn> => {
 ...
 * 初始化动画效果配置
 */
export const initializeAnimationEffect = async (): Promise<void> => {
  try {
    // 添加打开设置窗口事件监听
 ...
 * 销毁动画效果配置
 */
export const destroyAnimationEffect = (): void => {
  // 清除打开设置窗口事件监听
