<template>
  <svg t="1756804194661" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
       p-id="4612" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">
    <path d="M895.8 592.1a32.2 32.1 0 1 0 64.4 0 32.2 32.1 0 1 0-64.4 0Z" :fill="themeColors.universal.text" p-id="4613"></path>
    <path
        ...
        :fill="themeColors.universal.text" p-id="4614"></path>
  </svg>
</template>
