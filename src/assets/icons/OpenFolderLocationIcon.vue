<template>
  <svg t="1756972946442" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
       p-id="4666" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">
    <path d="M506 894.2a33 32.9 0 1 0 66 0 33 32.9 0 1 0-66 0Z" :fill="themeColors.universal.text" p-id="4667"></path>
    <path
        ...
        :fill="themeColors.universal.text" p-id="4668"></path>
  </svg>
</template>
