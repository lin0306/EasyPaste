  ...
  pages: {
    settings: {
      ...
      replaceGlobalHotkeyHint:
        '打开后会关闭系统自带的剪贴板功能，卸载程序前请先关闭此功能，否则无法使用剪贴板功能，关闭此功能后，默认快捷键会恢复成“Alt + C”',
      languages: '语言',
      autoGoToLatestData: '自动滚动到最新数据',
      autoGoToLatestDataHint:
        '打开后，每次复制新内容时，列表都会滚动到最新复制的内容所在的位置，关闭此功能后，每次复制新内容时，列表不会自动滚动',
      displayThumbnailImage: '显示缩略图',
      displayDetailTime: '显示详细时间',
      ...
      replaceImageStorageLocationConfirmBtn: '确认',
      replaceImageStorageLocationCancelBtn: '取消',
      ...
      shortcutHint:
        'Win键加字母键大部分都是系统键位，无法直接使用，如果需要替换系统自带的剪贴板功能，请到“通用设置”中打开“替换全局热键”设置',
      ...
      themeEditor: {
        ...
        resetBtn: '重置',
        saveBtn: '保存',
        loadingThemeFileMsg: '正在加载主题文件...',
        loadingThemeFileErrorMsg: '无法加载主题文件',
        exportingThemeFileMsg: '正在导出成主题文件...',
        resetFinishMsg: '重置完成',
        themeSaveSuccessMsg: '主题保存成功',
        exportedThemeFileModeContent: '主题文件已保存至：',
        openInFolderBtn: '打开文件所在位置',
        closeBtn: '关闭',
        editor: {
          global: {
            title: '全局颜色配置',
          ...
          button: {
            ...
            primary: {
              bgColor: '主按钮背景色：',
              hoverBgColor: '主按钮背景色（悬浮）：',
              disableBgColor: '主按钮背景色（禁用）：',
              textColor: '主按钮文本色：',
              textHoverColor: '主按钮文本色（悬浮）：',
              textDisableColor: '主按钮文本色（禁用）：',
            },
            normal: {
              bgColor: '普通按钮背景色：',
              hoverBgColor: '普通按钮背景色（悬浮）：',
              disableBgColor: '普通按钮背景色（禁用）：',
              textColor: '普通按钮文本色：',
              textHoverColor: '普通按钮文本色（悬浮）：',
              textDisableColor: '普通按钮文本色（禁用）：',
            },
            error: {
              bgColor: '异常按钮背景色：',
              hoverBgColor: '异常按钮背景色（悬浮）：',
              disableBgColor: '异常按钮背景色（禁用）：',
              textColor: '异常按钮文本色：',
              textHoverColor: '异常按钮文本色（悬浮）：',
              textDisableColor: '异常按钮文本色（禁用）：',
            },
          },
          select: {
            title: '选择器颜色配置',
            hoverBgColor: '背景色（悬浮未选中）：',
            activeBgColor: '背景色（选中）：',
            activeHoverBgColor: '背景色（悬浮选中）：',
          },
          titleBar: {
            title: '标题栏颜色配置',
            bgColor: '背景色：',
            btnHoverBgColor: '按钮背景色（悬浮）：',
            closeBtnHoverBgColor: '关闭按钮背景色（悬浮）：',
          },
          menuBar: {
            title: '菜单栏颜色配置',
            bgColor: '背景色：',
          ...
          textEditor: {
            title: '文本编辑器颜色配置',
            bgColor: '背景色：',
            lineNumberBgColor: '行号背景色：',
            lineNumberActiveBgColor: '行号背景色（选中）：',
          },
        },
        preview: {},
      },
    ...
    list: {
      ...
      registerOpenWindowShortcutKeysErrorHint:
        '唤醒程序快捷键【{keys}】注册失败，请检查快捷键是否被其他占用，可在【设置-快捷键】页面调整',
      registerQuickPasteShortcutKeysErrorHint:
        '快速粘贴快捷键【{keys}】注册失败，请检查快捷键是否被其他占用，可在【设置-快捷键】页面调整',
      chars: '字符',
      empty: '暂无剪贴板记录',
    ...
    preview: {
      ...
      fileCount: ' 个文件',
      cannotPreviewOffice:
        '暂时只支持预览docx、xlsx、pdf格式的文件，请点击右上角打开文件所在位置进行浏览',
    ...
    pluginStore: {
      ...
      localNoPluginHint: '前往插件市场安装',
      detailNoPluginHint: '请选择插件进行预览',
      storeNoPluginHint: '暂无可用插件',
      installSuccessHint: '插件${pluginName}安装成功',
      installNotUrlHint: '插件下载地址未提供，无法下载',
      installFailedHint: '插件下载失败',
      uninstallSuccessHint: '插件卸载成功',
      uninstallFailedHint: '插件卸载失败',
      notInstallHint: '插件未安装',
      updateSuccessHint: '插件${pluginName}更新成功',
      updateUnInstallFailedHint: '插件卸载失败',
      updateFailedHint: '插件安装失败，请重新安装',
      notPluginHint: '未找到插件信息',
      notSelectPluginHint: '请选择需要更新的插件',
    },
    plugins: {},
  },
}
