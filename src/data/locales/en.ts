...
export const english: LanguageConfig = {
  ...
  pages: {
    settings: {
      ...
      imageStorageTitle: 'Image Storage Settings',
      ...
      shortcutKeyOccupationHint:
        'The default clipboard shortcut key of the system is already occupied by another program. Please release the shortcut key first.',
      replaceGlobalHotkeyNoPermissionHint:
        'Please start the program as an administrator first, then you can modify this setting.',
      replaceGlobalHotkeyLinkHint: 'How to run a program as an administrator',
      replaceGlobalHotkeyHint:
        'After opening, the system\'s built-in clipboard function will be disabled. Before uninstalling the program, please turn off this function first. Otherwise, the clipboard function will not be usable. After turning off this function, the default shortcut key will revert to "Alt + C".',
      languages: 'Languages',
      autoGoToLatestData: 'Automatically scroll to the latest data',
      autoGoToLatestDataHint:
        "After opening, each time you copy a new item, the list will scroll to the latest copied item's position, and after closing this function, each time you copy a new item, the list will not automatically scroll.",
      ...
      timeIntervalHint:
        'Please enter the time interval, the unit is hour, the range is 1 hour to 30 days (720 hours)',
      ...
      maxHistoryItemsHint:
        'Limit the upper limit of data storage, 0 means no cleanup, maximum 10000 items',
      dataRetentionDays: 'Max Record Days',
      dataRetentionDaysHint:
        'Limit data retention time, exceeding the number of days will automatically clean up, 0 means no cleanup, maximum retention time is 365 days',
      enableImageSave: 'Save Image',
      enableImageSaveHint:
        'Since some of the images were generated using third-party screenshot tools, the system can only obtain the original image data but cannot retain the source information. Therefore, it is necessary to store them locally.',
      imageStorageLocation: 'Image Storage Location: ',
      imageStorageLocationHint:
        'Change the default storage location, subsequent uninstallation may not automatically delete the folder, please manually delete',
      ...
      replaceImageStorageLocationConfirm:
        'There are {num} images in the database, do you want to move them to the new folder?',
      replaceImageStorageLocationProcessing: 'Moving images...',
      replaceImageStorageLocationConfirmBtn: 'Confirm',
      replaceImageStorageLocationCancelBtn: 'Cancel',
      ...
      restartModalContent:
        'The "Replace Global Hotkeys" function will only take effect after restarting the computer. Would you like to restart now?',
      ...
      keyNotAvailableHint:
        'The shortcut keys are not available. Please check if they are being used by another program.',
      quickPasteKeyNotAvailableHint:
        '[{keys}] The shortcut key is unavailable. Please check if it is being used by another program.',
      keyRepeatHint:
        'The shortcut key conflicts with the [{keys}] shortcut key and saving is not allowed.',
      shortcutHint:
        'The Win key combined with letter keys are mostly system keys and cannot be directly used. If you need to replace the clipboard function provided by the system, please go to "General Settings" and enable the "Replace Global Hotkeys" setting.',

      saveSuccessMsg: 'Save Success',
      saveFailedMsg: 'Save Failed',
      shortcutSaveErrorMsg: 'Save Shortcut Settings Failed: ',
      resetSuccessMsg: 'Reset Success',
      enableReplaceGlobalHotkeyFailedMsg:
        'The "Replace Global Hotkeys" function failed to be enabled. Please confirm if the program was launched as an administrator.',
      disableReplaceGlobalHotkeyFailedMsg:
        'The "Replace Global Hotkey" option failed to be closed. Please confirm if the program was launched as an administrator.',
      ...
      animationHint:
        'Page transition animations can enhance visual experience, but may affect fluency on low-performance devices',
    ...
    list: {
      ...
      typeImage: 'Image',
      typeLink: 'Link',
      registerOpenWindowShortcutKeysErrorHint:
        'The registration of the shortcut key [{keys}] for the wake-up program failed. Please check if the shortcut key is occupied by other programs. You can adjust it on the 【Settings - Shortcut Keys】 page.',
      registerQuickPasteShortcutKeysErrorHint:
        'The quick paste shortcut key [{keys}] failed to register. Please check if the shortcut key is already in use by another program. You can adjust it on the "Settings - Shortcuts" page.',
      chars: 'chars',
    ...
    tags: {
      ...
      tagNameHint:
        'The label name should not exceed 5 characters. If it does, the extra characters will be hidden. For specific details, please refer to the preview effect.',
      tagColor: 'Tag Color',
      ...
      clearDataModalContent:
        'This operation will clear all data in the tag list. Please confirm if you want to continue?',
      clearDataModalCancelBtn: 'Cancel',
      clearDataModalConfirmBtn: 'Confirm',
    },
    about: {
    ...
    preview: {
      ...
      cannotPreview:
        'The file does not support preview, please click the upper right corner to open the file location for browsing',
      searchPlaceholder: 'Input keywords to search',
      cannotPreviewRtf:
        'The rtf file does not support preview, please click the upper right corner to open the file location for browsing.',
      cannotPreviewText:
        'The file size exceeds 10M and cannot be previewed. Please click the upper right corner to open the file location for browsing.',
      fileSize: 'File Size: ',
      fileType: 'File Type: ',
      ...
      fileCount: ' files',
      cannotPreviewOffice:
        'Currently, only files in docx, xlsx and pdf formats are supported for preview. Please click the upper right corner to browse the location where the file is stored.',
      nonsupportPreviewOffice:
        'Please open the Office file with professional software, please click the upper right corner to open the location of the file to browse',
      fileReadFailed: 'File Read Failed',
      packageDecompressionFailed: 'File decompression failed. Error reason: ',
      cannotPreviewPackage:
        'The file size exceeds 1G and cannot be previewed. Please click the upper right corner to open the file location for browsing.',
      cannotPreview7z:
        'The 7z file does not support preview, please click the upper right corner to open the file location for browsing.',
      folder: 'Folder',
    },
    pluginStore: {
      title: 'Plugin Store',
      storeTabTitle: 'Plugin Store',
      localTabTitle: 'Installed',
      updateBtn: 'Update',
      disableBtn: 'Disable',
      enableBtn: 'Enable',
      installBtn: 'Install',
      ...
      localNoPluginHint: 'Go to the plugin market to install.',
      detailNoPluginHint: 'Please select the plugin for preview.',
      storeNoPluginHint: 'No available plugins are currently available.',
      installSuccessHint: 'Plugin ${pluginName} has been installed successfully.',
      installNotUrlHint:
        'The download link for the plugin is not provided, so it is impossible to download.',
      installFailedHint: 'Plugin download failed',
      uninstallSuccessHint: 'Plugin uninstallation was successful.',
      uninstallFailedHint: 'Plugin uninstallation failed',
      notInstallHint: 'Plugin not installed',
      updateSuccessHint: 'Plugin ${pluginName} has been updated successfully.',
      updateUnInstallFailedHint: 'Plugin uninstallation failed',
      updateFailedHint: 'Plugin installation failed. Please reinstall.',
      notPluginHint: 'No plugin information found.',
      notSelectPluginHint: 'Please select the plugins that need to be updated.',
    },
    plugins: {},
  },
}
