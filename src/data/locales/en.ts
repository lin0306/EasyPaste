...
export const englishPageConfig: PageConfig = {
    settings: {
        ...
        maxStorageSizeHint: 'Limit the storage limit of file types, exceeding the disk limit will automatically clean up data',
        ...
        maxItemSizeHint: 'Limit the maximum size of each data of file types, exceeding the size will not be saved',
        search: 'Search',
