...
export function getPluginThemeOverrides(): GlobalThemeOverrides {
  ...
  return {
    ...
    Button: {
      ...
      textColorTextPrimary: colors.button.primary.backgroundColor,
      textColorTextHoverPrimary: colors.button.primary.hoverBackgroundColor,
      textColorTextFocusPrimary: colors.button.primary.hoverBackgroundColor,
      textColorTextPressedPrimary: colors.button.primary.hoverBackgroundColor,
      textColorTextDisabledPrimary: colors.button.primary.disabledBackgroundColor,
