...
[![](https://img.shields.io/badge/GitHub%20version-v0.1.5-blue.svg?cacheSeconds=2592000)](https://github.com/lin0306/EasyPaste/releases/latest)
[![](https://img.shields.io/badge/Gitee%20version-v0.1.5-green.svg?cacheSeconds=2592000)](https://gitee.com/lin0306/easy-paste/releases/latest)
...
│   │   ├── 📁 settings/       # 设置页面
│   │   │   ├── 📁 components/ # 设置页面组件
│   │   │   ├── 📁 composables/# 设置页面功能管理
│   │   │   └── index.vue      # 设置页面入口
│   │   ├── 📁 tags/           # 标签管理页面
│   │   │   ├── 📁 components/ # 标签页面组件
│   │   │   ├── 📁 composables/# 标签页面功能管理
│   │   │   └── index.vue      # 标签页面入口
│   │   ├── 📁 about/          # 关于页面
│   │   │   └── About.vue      # 关于页面组件
│   │   └── 📁 updater/        # 更新页面
